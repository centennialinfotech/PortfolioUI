...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-black text-white overflow-x-hidden relative">
      ...
      {/* BACKGROUND GLOW */}
      <div className="absolute top-0 left-0 w-[700px] h-[700px] bg-blue-500/20 rounded-full blur-[120px]">
      </div>

      <div className="absolute bottom-0 right-0 w-[700px] h-[700px] bg-purple-500/20 rounded-full blur-[120px]"></div>

      {/* NAVBAR */}
      <nav className="relative z-50 flex items-center justify-between px-6 md:px-16 lg:px-28 py-6 border-b border-white/10 backdrop-blur-xl">
  ...
  <div>
    ...
    <p className="text-[10px] sm:text-xs text-gray-500 mt-1 tracking-[3px] uppercase">
  ...
  <div className="flex items-center gap-4">
    ...
    {/* BUTTON */}
    <button className="hidden sm:block bg-gradient-to-r from-blue-500 to-purple-500 hover:scale-105 px-5 py-3 rounded-2xl font-semibold transition-all shadow-2xl">
      Get Started
    </button>
...
{menuOpen && (
  <div className="md:hidden absolute top-20 right-5 w-60 bg-[#111827] border border-white/10 rounded-3xl p-5 flex flex-col gap-5 shadow-2xl z-50">
    ...
    <button className="bg-gradient-to-r from-blue-500 to-purple-500 py-3 rounded-2xl font-semibold mt-2 hover:scale-105 transition-all">
      ...
      <section className="relative z-10 px-6 md:px-16 lg:px-28 py-10">
        ...
        <div className="max-w-[1400px] mx-auto grid lg:grid-cols-2 gap-24 items-center">
          ...
          <div>
            ...
            <p className="mt-6 md:mt-10 text-base sm:text-lg md:text-xl text-gray-300 leading-relaxed max-w-2xl">
